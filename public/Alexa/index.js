...
$(window).load(function() {
  ...
  var fix_class = 'fixed';
  var header_color='#019AD4';
  var darker_color='#2B5BD1';
  ...
  var waypoints = $('.top-bar').waypoint({
    handler: function(direction) {
      ...
      if(direction==='up'){
        ...
        $('#title').css("background","-webkit-linear-gradient(#00B4D6, #0072AC)");
  ...
  $(".fixed-box , .fixed-hovers").hover(
    function() {
      $('.fixed-hovers').css('border-top', 'solid 1px '+darker_color);
      $('.fixed-hovers').children('div').each(function(index){
        if(cur_slide_name!==" "){
          if(cur_slide_name.trim()===$(this).context.innerText){
            $(this).css("border-left","solid 4px "+darker_color);
