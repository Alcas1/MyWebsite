jQuery.fn.center = function() {
	...
	this.css("top", Math.max(0, (($(window).outerHeight() - $(this).outerHeight()/2-$(this).height())) + "px"));
	this.css("left", Math.max(0, (($(window).outerWidth() - $(this).outerWidth()/2-$(this).width())) + "px"));
	return this;
};
